...
def login():
    ...
    try:
        ...
        # Query ds_user table to get the hashed password and user_id
        select_query = "SELECT id, password FROM ds_user WHERE username = %s AND deleted = 0 AND status = 'active'"
        ...
        if user_record:
            ...
            if bcrypt.checkpw(password.encode('utf-8'), stored_hashed_password.encode('utf-8')):
                ...
                access_token = create_access_token(
                    ...
                    additional_claims={"user_id": user_id} # Store user_id in claims
                )
